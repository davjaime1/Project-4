                    ...
                    <tr>
                        ...
                        <td>
                            <nav class="head">
                                ...
                                <li><a class="current" href="AdminHomepage.php">ADMIN</a></li>
        ...
        <div class="tab">
            ...
            <div id="Inicio" class="tabcontent" style="display: block;">
                <table class="MostSold">
                    <tr>
                        <td>
                        <form name="InicioPage" class="contact" action="InicioUpdate.php" method="post">
            ...
            <div id="Sobre" class="tabcontent">
                <table class="MostSold">
                    <tr>
                    <td>
                        <form name="SobrePage" class="contact" action="SobreNosotrosUpdate.php" method="post">
                            <label style="padding-right: 20px;">
                            <input class="field_sizes1" type="text" id="fname" name="title" placeholder="Title" size="68" required>
                            </label>    
                            <input class="field_sizes1" type="text" id="lname" name="subtitle" placeholder="Sub Title" size="68" required><br>
            ...
            ?>
            <form name="MenuPage" class="contact" action="MenuUpdate.php" method="POST" enctype="multipart/form-data">
            ...
            <table class="MostSold">
                    <tr>
                    <td>
                        <form name="ContactPage" class="contact" action="ContactUpdate.php" method="post">
                            <label style="padding-right: 20px;">
                            <input class="field_sizes1" type="text" id="fname" name="title" placeholder="Title" size="68" required>
                            </label>    
                            <input class="field_sizes1" type="text" id="lname" name="subtitle" placeholder="Sub Title" size="68" required><br>
