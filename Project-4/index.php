...
<head>
    ...
    <div class="HeaderDiv">
        ...
        <?php
                ...
                $sql = "SELECT subtitle FROM inicio";
                $result = $conn->query($sql);
                if ($result->num_rows > 0)
                {
                    $row = $result->fetch_assoc();
        ...
        <table class="menubutton"><tr><td><a href="Menu.html" class="menu_button">VER MENÚ HOY</a></td></tr></table>
            ...
            <tr>
                <td>
                    ...
                    <?php
                        ...
                        $sql = "SELECT history1 FROM inicio";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0)
                        {
                            $row = $result->fetch_assoc();
                ...
                <td>
                    ...
                    <?php
                        ...
                        $sql = "SELECT history2 FROM inicio";
                        $result = $conn->query($sql);
                        if ($result->num_rows > 0)
                        {
                            $row = $result->fetch_assoc();
    ...
    <div class="MostSold">
        ...
        <table class="menubutton"><tr><td><a href="Menu.html" class="menu_button_lower">VER MENÚ HOY</a></td></tr></table>
