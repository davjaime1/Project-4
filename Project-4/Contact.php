...
<body>  
    <div class="HeaderDiv">
        ...
        <?php
                ...
                $sql = "SELECT subtitle FROM contact";
                $result = $conn->query($sql);
                if ($result->num_rows > 0)
                {
                    $row = $result->fetch_assoc();
        ...
        <div class="Contact">
            ...
            <form name="ContactPage" class="contact" action="ContactResponsePage.php" onsubmit="return validateContactForm()" method="post">
